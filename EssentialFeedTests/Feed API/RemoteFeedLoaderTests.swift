...
class RemoteFeedLoaderTests: XCTestCase {
    ...
    private func expect(_ sut: RemoteFeedLoader,
                        toCompleteWith exceptedResult: RemoteFeedLoader.Result,
                        when action: () -> Void,
                        file: StaticString = #file,
                        line: UInt = #line) {
